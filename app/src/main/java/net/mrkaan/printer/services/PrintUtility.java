...
import net.mrkaan.printer.ui.activities.WifiListActivity;
...
DebugLog.write();
    ...
    public void printTest(final File pdfFile) {
        DebugLog.write();
        this.pdfFile = pdfFile;

        // check connectivity info -> mobile or wifi.
        connectionInfo = Util.connectionInfo(mActivity);
         if (connectionInfo.equalsIgnoreCase(Constants.CONTROLLER_WIFI)) {
            // follow wifi flow..

            // this will get current wifiInfo and store it in shared preference.
            Util.storeCurrentWiFiConfiguration(mActivity);

             printerConfigurationTest();
    ...
    private void printerConfigurationTest() {
        doPrintTest();
    }
